+function($) {
    ...
    ArchivesFilter.prototype = {
        ...
        showResult: function(numbPosts) {
            if (numbPosts == 0) {
                this.$archiveResult.html('查無文章').show();
            }
            else if (numbPosts == -1) {
              ...
              console.log(123);
                this.$archiveResult.html('找到 ' + numbPosts + ' 篇文章').show();
            }
        },
    ...
    */
    showResult: function(numbCategories) {
      if (numbCategories == 0) {
        ...
        this.$archiveResult.html('找到 ' + numbCategories + ' 個分類').show();
      }
    },
    ...
    */
    showResult: function(numbTags) {
      if (numbTags === 0) {
        ...
        this.$archiveResult.html('找到 ' + numbTags + ' 個標籤').show();
      }
    },
